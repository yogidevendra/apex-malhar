...
import com.datatorrent.lib.io.output.Synchronizer.StitchBlockMetaData;
    ...
    protected void starting(org.junit.runner.Description description)
    {
      ...
      try{
        for(int i=0; i< blockIds.length; i++){
          ...
          StitchBlockMetaData outputFileBlockMetaData = new StitchBlockMetaData(fmd, outputFileName, (i==blockIds.length-1));
...
@Test(expected = BlockNotFoundException.class)
  public void testMissingBlock() throws IOException, BlockNotFoundException
  {
    ...
    testFM.underTest.tempOutFilePath = new Path(testFM.baseDir, testFM.fileMetaDataMock.getStitchedFileRelativePath() + '.' + System.currentTimeMillis() + FileStitcher.PART_FILE_EXTENTION);
